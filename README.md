...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-24 20:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/003fa56a-8bcf-473f-996d-1fd6f54fde46.git
$ cd 003fa56a-8bcf-473f-996d-1fd6f54fde46
```
